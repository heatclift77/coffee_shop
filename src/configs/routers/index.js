import {Login, Profil, SignUp, Products, ProductDetails, ForgotPassword, 
    Homepage, UserVerify, Payment, ChangePassword, AdminAddPromo} from '../../pages'
    ...
    return (
        <Router>
            <Switch>
                ...
                <Route path='/Admin/Promo' component={AdminAddPromo} />
